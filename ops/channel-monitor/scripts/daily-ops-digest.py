...
def _build_digest(
    ...
    *,
    ...
    blocked_reasons = {"upstream_collection_incomplete", "critical_model_alert", "no_trusted_cost_evidence", "model_evidence_error"}
    ...
    if pricing_run.get("error"):
        ...
        pricing_status = "partial" if any(row.get("action") == "apply" for row in decisions) else "blocked"
