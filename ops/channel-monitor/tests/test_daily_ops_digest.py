...
class DigestBuilderTests(unittest.TestCase):
    ...
    def test_missing_daily_artifacts_are_labeled_without_blocking_other_sections(self):
        ...
        self.assertTrue(report["channels"])
    ...
    def test_stale_recharge_summary_does_not_block_delivery_or_invent_total(self):
        recharges = {
            "source": "authenticated_upstream_recharge_records",
            "generated_at": 1,
            "complete": 0,
