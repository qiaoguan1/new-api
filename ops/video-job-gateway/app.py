...
from store import (
    ...
    GENERATION_CAPACITY_FAILURE_THRESHOLD,
    GENERATION_CAPACITY_WINDOW_SECONDS,
...
class Gateway:
    ...
    def provider_health(self) -> dict[str, Any]:
        ...
        return {
            ...
            "window_seconds": 300,
            "failure_threshold": 3,
            "temporary_capacity_window_seconds": GENERATION_CAPACITY_WINDOW_SECONDS,
            "temporary_capacity_failure_threshold": GENERATION_CAPACITY_FAILURE_THRESHOLD,
