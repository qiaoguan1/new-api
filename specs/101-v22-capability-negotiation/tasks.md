...
- [x] T001 Create and place Issue #101 in the project as In Progress.
- [x] T002 Reproduce the v2.2 capability mismatch through production Nginx.
- [x] T003 Freeze the compatibility and failure-closed requirements.
- [x] T004 Add failing endpoint and capability snapshot tests.
