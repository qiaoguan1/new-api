...
- [x] T001 Record explicit refund authorization on Issue #111.
- [x] T002 Create an isolated branch from `origin/main` and set project status In Progress.
- [x] T003 Freeze requirements and financial safety boundaries.
- [x] T004 Trace the existing refund program and prove the global incomplete-source defect.
- [x] T005 Capture channel-to-upstream mappings and eligible evidence fixtures.
- [x] T006 Add failing source-isolation and refund-calculation tests.
