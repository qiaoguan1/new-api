...
- [x] T001 Create Issue #9 and set project status to In Progress
- [x] T002 Inspect real NewAPI routes and Channel Monitor admin surfaces
- [x] T003 Add failing tests for standalone entries and create-dialog mapping
