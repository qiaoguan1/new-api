...
- [x] T001 Create Issue #128, add it to Project 3, and set In Progress.
- [x] T002 Create isolated branch `codex/issue-128-hanhe-actual-cost`.
- [x] T003 Add failing `actual_cost` aggregation and pricing-policy tests.
