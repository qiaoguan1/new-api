...
func truncate(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		model.DB.Exec("DELETE FROM video_task_settlements")
		...
		model.DB.Exec("DELETE FROM xing_tu_video_webhook_events")
	})
}
